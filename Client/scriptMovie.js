    ...
    tableBodyContent += `
              <tr>
                ...
                <td>
                  ...
                  openUpdateModal();showValues();" class="modal-winodw" id="update-movie" style="background-color:#1e81d3">
                    Update Movie
                  </button>
              ...
              `;
    document.getElementById("movie-table").innerHTML = tableBodyContent;
  }
};
