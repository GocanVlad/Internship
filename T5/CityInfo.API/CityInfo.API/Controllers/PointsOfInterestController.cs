...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreationPointOfInterest(int cityId,[FromBody] PointOfInterestForCreationDto pointsOfInterest)
        {
            ...
            [FromBody] PointOfInterestForUpdateDto pointOfInterest)
        {
            ...
            var pointOfInterestEntity = _cityInfoRepository
                .GetPointsOfInterestForCity(cityId, id);
        ...
        public IActionResult DeletePointOfInterest(int cityId, int id)
        {
            ...
            _mailService.Sent("Point of interest deleted.",
