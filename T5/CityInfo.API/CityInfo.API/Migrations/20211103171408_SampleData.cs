    ...
    public partial class SampleData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Description", "Name" },
                values: new object[] { 2, "The one with that cathedral.", "Antwerp" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "The most visited urban park in the U.S.", "Central Park" },
                    { 2, 1, "A 102-story skyscraper in Manhattan.", "Empire State Building" },
                    { 3, 2, "A Gothic style cathedral.", "Cathedral" },
                    { 4, 2, "The finest example of railway architecture in Belgium.", "Antwrep Central Station" },
