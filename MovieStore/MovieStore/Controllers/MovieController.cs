...
namespace MovieStore.Controllers
{
    ...
    public class MovieController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public IActionResult GetMovie(int id, bool includeRating = false)
        {
            var movie = _movieRepository.GetMovie(id, includeRating);
            ...
            if (includeRating)
            {
                var movieResult = _mapper.Map<Movie>(movie);
        ...
        [HttpPost]
        public IActionResult CreationMovie([FromBody] MovieForCreationDto movie)
        {
